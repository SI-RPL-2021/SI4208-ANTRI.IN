...
<head>
    ...
    <link rel="" href="" type="" sizes="128x128">
</head>
                ...
                <ul class="navbar-nav d-flex">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li>
                                <a class="dropdown-item" href="" onmouseover="this.style.color='red';" onmouseout="this.style.color='';">Log out</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="row gy-5">
                        <div class="col-6">
                            <div class="p-3 border bg-light">
                                <h5 class="card-title">Obat Pusing </h5>
                            </div>
                            <br><br>
                            <div class="p-3 border bg-light">

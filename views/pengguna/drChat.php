...
$id_dok_akun = $dok_log['id_akun_dok'];
$_SESSION['dok_id_chat'] = $id_dok_akun;
$_SESSION['usr_id_chat'] = 4280444697;
...
$chat_data = data_views("SELECT * FROM chat_online WHERE id_dok_chat = ?", $id_dok_akun);
    ...
    <div class="d-flex justify-content-between">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            <div class="container">
                ...
                <a href="drReservasi.php" type="button" class="btn btn-danger">Cancel</a>
                &nbsp;&nbsp;
        </nav>
    </div>
        ...
        <div class="row">
            ...
            <form action="../../controllers/add_data.php" method="POST">
                ...
                <div class="col-md-1 mt-3">
                    <input type="hidden" class="form-control" id="rsvvvvvs" name='ownership_chat' value='dokter'></input>
                    <input type="submit" class="btn btn-primary" value="Kirim" name="add_chat_dok"></input>
                </div>
            </form>
        </div>
        <br>

                    ...
                    <form action="../controllers/add_data.php" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="username_regis" required id="username_regis"
                                aria-describedby="usernameHelp" placeholder="Tulis username anda disini">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" name="kata_sandi_reg" required
                                id="kata_sandi_reg" aria-describedby="passwordHelp"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="email_reg" id="email_reg"
                                aria-describedby="emailHelp" placeholder="Tulis email anda disini">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="jeniskelamin" class="form-control" id="jeniskelamin" name="jeniskelamin"
                                aria-describedby="jeniskelaminHelp" placeholder="Tulis jenis kelamin anda disini">
                        </div>
                        <div class="mb-3">
                            <label for="birthday" class="form-label">Tanggal Lahir</label>
                            <input type="date" class="form-control" name="birthday" id="birthday"
                                aria-describedby="birthdayHelp" placeholder="Tulis tanggal lahir anda disini">
                        </div>
                        <div class="mb-3">
                            <label for="alamat" class="form-label">Alamat</label>
                            <input type="alamat" class="form-control" id="alamat" name="alamat"
                                aria-describedby="alamatHelp" placeholder="Tulis alamat lahir anda disini">
                        </div>
                        <div class="mb-3">
                            <label for="ktp" class="form-label">No. KTP</label>
                            <input type="ktp" class="form-control" id="ktp" name="ktp" aria-describedby="ktpHelp"
                                placeholder="Tulis nomor KTP anda disini">
                        </div>
                        <div class="mb-3">
                            <label for="telepon" class="form-label">No. Telepon</label>
                            <input type="telepon" class="form-control" id="telepon" name="telepon"
                                aria-describedby="teleponHelp" placeholder="Tulis nomor telepon anda disini">
                        </div>

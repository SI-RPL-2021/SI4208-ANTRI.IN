                ...
                <div class="col-sm">
                    ...
                    <form action="">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="dokter" class="form-control" id="exampleInputDokter"
                                aria-describedby="dokterHelp">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputJadwal" class="form-label">Jadwal Praktik</label>
                            <input type="jadwal" class="form-control" id="exampleInputJadwal"
